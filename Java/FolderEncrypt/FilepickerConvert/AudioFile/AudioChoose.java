...
public class AudioChoose extends ListActivity {
...
String screenshot,algorithm;
    ...
    private void fill(File f)
    {
        ...
        try{
            for(File ff: dirs)
            {
                ...
                if(ff.isDirectory()){
                    ...
                    if (ff.getName().endsWith("mp3") || ff.getName().endsWith("wav") || ff.getName().endsWith("rec") || ff.getName().endsWith("m4a")|| ff.getName().endsWith("aac")|| ff.getName().endsWith("flac")|| ff.getName().endsWith("ogg")|| ff.getName().endsWith("wma"))
                    {

                        fls.add(new DecryptItem(ff.getName(),ff.length() + " Byte", date_modify, ff.getAbsolutePath(),"filesound1"));
                    }
        ...
        adapter = new DecryptArrayAdapter(AudioChoose.this, R.layout.file_view,dir);
